...
#endif
    {
        ...
        if (nextBlockTail != blockFront
            ...
            if (tailBlock_->next.load() != frontBlock) {
                ...
                fence(
                    memory_order_acquire); // Ensure we get latest writes if we got the latest frontBlock
                ...
                auto newBlockSize = largestBlockSize >= MAX_BLOCK_SIZE ? largestBlockSize
                                                                       : largestBlockSize * 2;
...
public:
    ...
    {
        return wait_dequeue_timed(result,
