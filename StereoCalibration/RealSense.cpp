                              ...
                              float exposure_level)
{
    ...
    for (auto &sensor : sensors) {
        ...
        if (sensor.supports(RS2_OPTION_ENABLE_AUTO_EXPOSURE)) {
            ...
            std::cout << "Auto exposure disabled for sensor: "
        ...
        if (sensor.supports(RS2_OPTION_EXPOSURE)) {
            ...
            std::cout << "Exposure set to 3000 for sensor: "
                      << sensor.get_info(RS2_CAMERA_INFO_NAME) << std::endl;
        }
        ...
        if (sensor.supports(RS2_OPTION_GAIN)
            ...
            std::cout << "Gain set to 16 for sensor: " << sensor.get_info(RS2_CAMERA_INFO_NAME)
                      << std::endl;
        }
    }
