...
public:
    ...
    StereoCalibClass(int board_width,
                     int board_height,
                     float square_size,
...
private:
    ...
    void prepareObjectPoints(); // Depending on the size of the left_image_points, we create vector
                                // of vector of checkerboard points
};
