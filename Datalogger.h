...
const std::string SCANNING_CSV_HEADER="System Time,Run Time (seconds),Depth Frame #,US Frame #,Landmark"
...
public:
	...
	Datalogger(std::string root_path, std::string participant_directory,
		...
		std::string& left_camera_intrinsics, std::string& right_camera_intrinsics, std::string& R_string, std::string& T_string, 
		std::string& E_string, std::string& F_string,
